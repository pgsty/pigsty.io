...
weight: 555
description: Self-host enterprise-grade Supabase with Pigsty, featuring monitoring, high availability, PITR, IaC, and 555 PostgreSQL extensions.
module: [SOFTWARE]
...
Self-hosted Supabase with Pigsty provides up to [**555**](/ext/list) ready-to-use PostgreSQL extensions.
...
After these configurations, you have enterprise-grade Supabase with public domain, HTTPS certificate, SMTP, PITR backup, monitoring, IaC, and access to 555 PostgreSQL extensions (basic single-node version).
