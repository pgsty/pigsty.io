...
weight: 555
description: Self-host enterprise-grade Supabase with Pigsty, featuring monitoring, high availability, PITR, IaC, and 531 PostgreSQL extensions.
module: [SOFTWARE]
...
Self-hosted Supabase with Pigsty provides up to [**531**](/ext/list) ready-to-use PostgreSQL extensions.
