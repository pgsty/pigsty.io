...
Self-hosted Supabase with Pigsty provides up to [**562**](/ext/list) ready-to-use PostgreSQL extensions.
...
After these configurations, you have enterprise-grade Supabase with public domain, HTTPS certificate, SMTP, PITR backup, monitoring, IaC, and access to 562 PostgreSQL extensions (basic single-node version).
