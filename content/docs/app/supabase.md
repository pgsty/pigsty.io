...
weight: 555
description: Self-host enterprise-grade Supabase with Pigsty, featuring monitoring, high availability, PITR, IaC, and 510 PostgreSQL extensions.
module: [SOFTWARE]
...
Self-hosted Supabase with Pigsty provides up to [**510**](/ext/list) ready-to-use PostgreSQL extensions.
...
With this self-hosted architecture, you gain the freedom to use different kernels (PG 15-18, OrioleDB), install [**510**](/ext/list/) extensions, scale Supabase/Postgres/MinIO, freedom from database operations, and freedom from vendor lock-in — running locally forever. Compared to cloud service costs, you only need to prepare servers and run a few commands.
...
After these configurations, you have enterprise-grade Supabase with public domain, HTTPS certificate, SMTP, PITR backup, monitoring, IaC, and access to 510 PostgreSQL extensions (basic single-node version).
