...
weight: 615
description: Deploy Docker Registry pull-through cache and optional web UI with Pigsty v4.3.
module: [SOFTWARE]
categories: [Reference]
---

Pigsty v4.3 provides the `app/registry` template (`conf/app/registry.yml`) for:
