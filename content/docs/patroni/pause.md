...
[patronictl](/docs/patroni/patronictl#patronictl) supports [pause](/docs/patroni/patronictl#patronictl_pause) and [resume](/docs/patroni/patronictl#patronictl_resume) commands.
