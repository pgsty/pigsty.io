...
The `recover` sub-command can be used as a custom bootstrap or custom replica creation method. You can find more information about that in [replica_imaging_and_bootstrap](/docs/patroni/replica_bootstrap#replica_imaging_and_bootstrap).
