...
> [!NOTE]
> Because the upstream [`minio/minio`](https://github.com/minio/minio) repository is no longer maintained, Pigsty has switched to its own maintained [`pgsty/minio`](https://github.com/pgsty/minio) branch.
