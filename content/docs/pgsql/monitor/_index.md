...
> [!NOTE] Limitations when monitoring external Postgres instances
...
> [!DETAILS]- Example: Monitoring Aliyun RDS for PostgreSQL and PolarDB
...
> [!DETAILS]- Monitoring schema and monitoring view definitions
...
> [!DETAILS]- Function for viewing shared memory allocation (PG13 and above)
> ```sql
