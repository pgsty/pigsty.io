...
Pigsty provides [**562 extensions**](/ext/list). Using extensions involves four steps: **Download**, **Install**, **Configure**, **Enable**.
...
- [**Extension Catalog**](/ext/list): Browse 562 available extensions
