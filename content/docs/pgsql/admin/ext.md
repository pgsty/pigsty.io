...
Pigsty provides [**531 extensions**](/ext/list). Using extensions involves four steps: **Download**, **Install**, **Configure**, **Enable**.
...
- [**Extension Catalog**](/ext/list): Browse 531 available extensions
