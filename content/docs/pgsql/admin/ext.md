...
Pigsty provides [**507 extensions**](/ext/list). Using extensions involves four steps: **Download**, **Install**, **Configure**, **Enable**.
...
- [**Extension Catalog**](/ext/list): Browse 507 available extensions
