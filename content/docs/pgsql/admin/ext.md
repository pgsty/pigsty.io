...
Pigsty provides [**510 extensions**](/ext/list). Using extensions involves four steps: **Download**, **Install**, **Configure**, **Enable**.
...
- [**Extension Catalog**](/ext/list): Browse 510 available extensions
