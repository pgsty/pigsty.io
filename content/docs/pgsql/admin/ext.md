...
Pigsty provides [**{{< param pgext_count >}} extensions**](/ext/list). Using extensions involves four steps: **Download**, **Install**, **Configure**, **Enable**.
...
- [**Extension Catalog**](/ext/list): Browse {{< param pgext_count >}} available extensions
