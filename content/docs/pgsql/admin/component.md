---
title: Managing PostgreSQL Components
linkTitle: Component Management
weight: 70
description: Common PostgreSQL administration procedures in Pigsty for maintaining production database clusters.
...
See [Backup & Restore](/docs/pgsql/backup#backup) for more information.
...
The command will output an operations manual, follow the instructions. See [Backup & Restore - PITR](/docs/pgsql/backup/restore) for details.
