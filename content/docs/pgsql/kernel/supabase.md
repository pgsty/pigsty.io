...
and compared to Supabase cloud services, it provides up to [**504**](/ext/) out-of-the-box PostgreSQL extensions and can more fully utilize the performance and cost advantages of modern hardware.
