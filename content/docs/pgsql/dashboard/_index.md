...
title: Dashboard
weight: 1901
description: Pigsty provides numerous out-of-the-box Grafana monitoring dashboards for PostgreSQL
...
- [pgsql-alert](https://demo.pigsty.io/d/pgsql-alert): Global key metrics and alert events for PGSQL
- [pgsql-shard](https://demo.pigsty.io/d/pgsql-shard): Overview of horizontally sharded PGSQL clusters (e.g., Citus/GPSQL)

**Cluster**

- [pgsql-cluster](https://demo.pigsty.io/d/pgsql-cluster): Main dashboard for a PGSQL cluster
- [pgrds-cluster](https://demo.pigsty.io/d/pgrds-cluster): RDS version of PGSQL Cluster, focusing on PostgreSQL-native metrics
- [pgsql-activity](https://demo.pigsty.io/d/pgsql-activity): Session/load/QPS/TPS/locks for PGSQL cluster
- [pgsql-replication](https://demo.pigsty.io/d/pgsql-replication): Replication, slots, and pub/sub for PGSQL cluster
- [pgsql-service](https://demo.pigsty.io/d/pgsql-service): Service, proxy, routing, and load balancing for PGSQL cluster
- [pgsql-databases](https://demo.pigsty.io/d/pgsql-databases): Database CRUD, slow queries, and table statistics across all instances
- [pgsql-patroni](https://demo.pigsty.io/d/pgsql-patroni): HA status and Patroni component status for cluster
- [pgsql-pitr](https://demo.pigsty.io/d/pgsql-pitr): PITR context for point-in-time recovery assistance

**Instance**

- [pgsql-instance](https://demo.pigsty.io/d/pgsql-instance): Main dashboard for a single PGSQL instance
- [pgrds-instance](https://demo.pigsty.io/d/pgrds-instance): RDS version of PGSQL Instance, focusing on PostgreSQL-native metrics
- [pgcat-instance](https://demo.pigsty.io/d/pgcat-instance): Instance info retrieved directly from database catalog
- [pgsql-proxy](https://demo.pigsty.io/d/pgsql-proxy): Detailed metrics for a single HAProxy load balancer
- [pgsql-pgbouncer](https://demo.pigsty.io/d/pgsql-pgbouncer): Metrics overview for a single Pgbouncer connection pooler
- [pgsql-persist](https://demo.pigsty.io/d/pgsql-persist): Persistence metrics: WAL, XID, checkpoint, archive, IO
- [pgsql-session](https://demo.pigsty.io/d/pgsql-session): Session and active/idle time metrics for a single instance
- [pgsql-xacts](https://demo.pigsty.io/d/pgsql-xacts): Transaction, lock, TPS/QPS related metrics
- [pgsql-exporter](https://demo.pigsty.io/d/pgsql-exporter): Self-monitoring metrics for Postgres and Pgbouncer exporters
...
- [pgcat-database](https://demo.pigsty.io/d/pgcat-database): Database info retrieved directly from database catalog
- [pgsql-tables](https://demo.pigsty.io/d/pgsql-tables): Table/index access metrics within a single database
- [pgsql-table](https://demo.pigsty.io/d/pgsql-table): Detailed info for a single table (QPS/RT/index/sequence...)
- [pgcat-table](https://demo.pigsty.io/d/pgcat-table): Detailed table info from database catalog (stats/bloat...)
- [pgsql-query](https://demo.pigsty.io/d/pgsql-query): Detailed info for a query type (QPS/RT)
- [pgcat-query](https://demo.pigsty.io/d/pgcat-query): Query details from database catalog (SQL/stats)
- [pgcat-schema](https://demo.pigsty.io/d/pgcat-schema): Schema info from database catalog (tables/indexes/sequences...)
- [pgcat-locks](https://demo.pigsty.io/d/pgcat-locks): Activity and lock wait info from database catalog
...
[PGSQL Alert](https://demo.pigsty.io/d/pgsql-alert): Global core metrics overview and alert events
...
[PGSQL Shard](https://demo.pigsty.io/d/pgsql-shard): Cross-shard metric comparison for horizontally sharded PGSQL clusters (e.g., CITUS/GPSQL)
...
[PGSQL Exporter](https://demo.pigsty.io/d/pgsql-exporter): Self-monitoring metrics for Postgres/Pgbouncer exporters
...
[PGLOG Session](https://demo.pigsty.io/d/pglog-session): Log details for a single session in CSV log samples
