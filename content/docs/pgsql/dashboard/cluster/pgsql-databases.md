...
weight: 6
description: Database CRUD, slow queries, and table statistics across all instances
---

> Database CRUD, slow queries, and table statistics: [Demo](https://demo.pigsty.io/ui/d/pgsql-databases)
