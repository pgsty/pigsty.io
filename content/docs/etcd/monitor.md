...
Pigsty provides five preset alert rules for etcd, defined in [`files/victoria/rules/etcd.yml`](https://github.com/pgsty/pigsty/blob/main/files/victoria/rules/etcd.yml):
