...
{{< nav-card title="PILOT" link="/docs/pilot/" icon="fa-solid fa-flask-vial" accent="gray" badge="PILOT" desc="Experimental module family: Kubernetes, DuckDB, MySQL, TigerBeetle, ... for early adopters." />}}
{{< /nav-cards >}}
...
{{< /nav-card >}}
{{< nav-card title="Extension Catalog" link="/ext/" icon="fa-solid fa-puzzle-piece" desc="A complete catalog of 531 PostgreSQL ecosystem extensions: metadata, docs, downloads, and support matrix." >}}
