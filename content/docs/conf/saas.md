...
title: demo/saas
weight: 1080
description: Legacy single-node SaaS bundle with PostgreSQL, MinIO, Redis, and multiple application entrypoints
icon: fa-solid fa-layer-group
categories: [Reference]
---

`demo/saas` is a legacy feature-rich single-node example with predefined business users, databases, and application entrypoints. It demonstrates how PostgreSQL, MinIO, Redis, Docker, and the portal can be combined.
...
The template contains placeholder database users and databases for Grafana, Bytebase, Kong, Gitea, Wiki, NocoDB, and Odoo. It uses MinIO as the pgBackRest repository and includes a Redis replica example and multiple portal domains.
