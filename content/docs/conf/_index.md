...
| Misc Templates   | [`docker`](/docs/conf/docker/), [`mongo`](/docs/conf/mongo/), [`demo/el`](/docs/conf/el/), [`demo/debian`](/docs/conf/debian/), [`demo/demo`](/docs/conf/demo/), [`demo/minio`](/docs/conf/minio/), [`build/oss`](/docs/conf/oss/), [`build/pro`](/docs/conf/pro/)                 |
