...
and provide a ready-to-use configuration template [`mongo.yml`](https://github.com/pgsty/pigsty/blob/v4.1.0/conf/mongo.yml) to help you easily deploy enterprise-grade FerretDB clusters.
