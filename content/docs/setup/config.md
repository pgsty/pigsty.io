...
You can install [**different major versions**](/docs/pgsql/config/kernel) of PostgreSQL, and up to [**524**](/ext/list) [**extensions**](/docs/pgsql/ext). Let's remove the current default PG 18 and install PG 16:
