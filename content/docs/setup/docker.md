...
- Tags match Pigsty versions: `v4.3.0`, `latest`, etc.
...
```bash
PIGSTY_VERSION=<version>      # Image tag (example: v4.3.0 or latest)
...
|:--------------------|:---------|:----------|:------------------|
| `PIGSTY_VERSION`    | `<version>` | -         | Image tag (e.g. `v4.3.0` / `latest`) |
