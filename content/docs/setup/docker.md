...
- Tags match Pigsty versions: `v4.2.2`, `latest`, etc.
...
```bash
PIGSTY_VERSION=<version>      # Image tag (example: v4.2.2 or latest)
...
|:--------------------|:---------|:----------|:------------------|
| `PIGSTY_VERSION`    | `<version>` | -         | Image tag (e.g. `v4.2.2` / `latest`) |
