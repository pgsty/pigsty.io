...
The single-node version of Pigsty includes all core features: **562** [**PG extensions**](/docs/pgsql/ext), self-contained Grafana/Victoria monitoring, [**IaC**](/docs/concept/iac) provisioning capabilities,
