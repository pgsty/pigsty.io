...
| Name                                                                                                    | Version   | License                                                                                       | Comment                                       |
|---------------------------------------------------------------------------------------------------------|-----------|-----------------------------------------------------------------------------------------------|-----------------------------------------------|
| [`victoria-metrics`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                | `1.143.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | High-performance TSDB, Prometheus alternative |
...
| [`victoria-metrics-cluster`](https://github.com/VictoriaMetrics/VictoriaMetrics)                        | `1.143.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics distributed cluster           |
| [`vmutils`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.143.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics CLI utilities                 |
...
| [`node_exporter`](https://github.com/prometheus/node_exporter)            | `1.12.2` | [Apache-2.0](https://github.com/prometheus/node_exporter/blob/master/LICENSE)         | Expose Linux node metrics          |
...
| [`redis_exporter`](https://github.com/oliver006/redis_exporter)           | `1.83.0` | [MIT](https://github.com/oliver006/redis_exporter/blob/master/LICENSE)                | Expose redis metrics               |
...
| [`rustfs`](https://github.com/rustfs/rustfs)            | `1.0.0-b2`       | [Apache-2.0](https://github.com/rustfs/rustfs/blob/main/LICENSE)                | FOSS MinIO, Beta                   |
...
| [`seaweedfs`](https://github.com/seaweedfs/seaweedfs)   | `4.23`           | [Apache-2.0](https://github.com/seaweedfs/seaweedfs/blob/master/LICENSE)        | S3 for small files                 |
| [`rclone`](https://github.com/rclone/rclone/)           | `1.74.1`         | [MIT](https://github.com/rclone/rclone/blob/master/COPYING)                     | S3 command line tool               |
...
| Name                                                        | Version   | License                                                                            | Comment                                 |
|-------------------------------------------------------------|-----------|------------------------------------------------------------------------------------|-----------------------------------------|
| [`etcd`](https://github.com/etcd-io/etcd)                   | `3.6.11`  | [Apache-2.0](https://github.com/etcd-io/etcd/blob/main/LICENSE)                    | Fault-tolerant distributed coordination |
...
| [`tigerbeetle`](https://github.com/tigerbeetle/tigerbeetle) | `0.17.4` | [Apache-2.0](https://github.com/tigerbeetle/tigerbeetle/blob/main/LICENSE)         | Financial OLTP                          |
...
| [`pgstream`](https://github.com/xataio/pgstream)                                        | `1.0.2`    | [Apache-2.0](https://github.com/xataio/pgstream/blob/main/LICENSE)                      | PostgreSQL replication with DDL changes                         |
...
| [`sabiql`](https://github.com/riii111/sabiql)                                           | `1.12.2`    | [MIT](https://github.com/riii111/sabiql/blob/main/LICENSE)                              | Modern SQL client for PostgreSQL and MySQL                      |
| [`postgrest`](https://github.com/PostgREST/postgrest)                                   | `14.11`     | [MIT](https://github.com/PostgREST/postgrest/blob/main/LICENSE)                         | PostgreSQL RESTful API server                                   |
| [`npgsqlrest`](https://github.com/vb-consulting/NpgsqlRest)                             | `3.15.1`   | [MIT](https://github.com/vb-consulting/NpgsqlRest/blob/master/LICENSE.md)               | .NET PostgreSQL REST API generator                              |
...
| [`cloudflared`](https://github.com/cloudflare/cloudflared)                              | `2026.3.0` | [Apache-2.0](https://github.com/cloudflare/cloudflared/blob/master/LICENSE)             | Cloudflare tunnel client                                        |
...
| [`stalwart`](https://github.com/stalwartlabs/stalwart)                                  | `0.16.4`   | [AGPLv3](https://github.com/stalwartlabs/stalwart/blob/main/LICENSE)                    | Modern full-featured mail server                                |
| [`maddy`](https://github.com/foxcpp/maddy)                                              | `0.9.4`    | [GPL-3.0](https://github.com/foxcpp/maddy/blob/master/LICENSE)                          | Lightweight mail server                                         |
{.stretch-last}
...
| Name                                                           | Version   | License                                                                     | Comment                                                    |
|----------------------------------------------------------------|-----------|-----------------------------------------------------------------------------|------------------------------------------------------------|
| [`claude`](https://github.com/anthropics/claude-code)          | `2.1.138` | [Proprietary](https://www.anthropic.com/legal/terms)                        | Claude Code - Anthropic agentic coding                     |
| [`opencode`](https://github.com/anomalyco/opencode)            | `1.14.48` | [MIT](https://github.com/anomalyco/opencode/blob/main/LICENSE)              | Terminal AI coding assistant                               |
| [`codex`](https://github.com/openai/codex)                     | `0.130.0` | [Apache-2.0](https://github.com/openai/codex/blob/main/LICENSE)             | OpenAI coding agent CLI                                    |
| [`crush`](https://github.com/charmbracelet/crush)              | `0.66.1`  | [FSL-1.1-MIT](https://github.com/charmbracelet/crush/blob/main/LICENSE.md)  | Charm's terminal AI coding agent                           |
| [`agentsview`](https://github.com/wesm/agentsview)             | `0.29.0`  | [MIT](https://github.com/wesm/agentsview/blob/main/LICENSE)                 | Browse and replay AI coding agent trajectories in terminal |
...
| [`code-server`](https://github.com/coder/code-server)          | `4.118.0` | [MIT](https://github.com/coder/code-server/blob/main/LICENSE)               | VS Code in the browser                                     |
...
| [`uv`](https://github.com/astral-sh/uv)                        | `0.11.13`  | [MIT](https://github.com/astral-sh/uv/blob/main/LICENSE-MIT)                | Next-gen Python package manager                            |
| [`golang`](https://golang.org/)                                | `1.26.3`  | [BSD-3](https://github.com/golang/go/blob/master/LICENSE)                   | Go compiler                                                |
