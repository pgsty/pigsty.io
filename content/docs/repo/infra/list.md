...
| [`victoria-traces`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                 | `0.8.1`   | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | Distributed tracing backend                   |
...
| [`rustfs`](https://github.com/rustfs/rustfs)            | `1.0.0-alpha.94`       | [Apache-2.0](https://github.com/rustfs/rustfs/blob/main/LICENSE)                | FOSS MinIO, Alpha                  |
...
| Name                                                        | Version   | License                                                                            | Comment                                 |
|-------------------------------------------------------------|-----------|------------------------------------------------------------------------------------|-----------------------------------------|
| [`etcd`](https://github.com/etcd-io/etcd)                   | `3.6.10`  | [Apache-2.0](https://github.com/etcd-io/etcd/blob/main/LICENSE)                    | Fault-tolerant distributed coordination (EL only; APT deferred pending patroni 4.1.1) |
...
| Name                                                                                    | Version    | License                                                                                 | Comment                                                         |
|-----------------------------------------------------------------------------------------|------------|-----------------------------------------------------------------------------------------|-----------------------------------------------------------------|
| [`pig`](https://github.com/pgsty/pig)                                                   | `1.4.0`    | [Apache-2.0](https://github.com/pgsty/pig/blob/main/LICENSE)                            | PG package manager                                              |
...
| [`sabiql`](https://github.com/riii111/sabiql)                                           | `1.11.0`    | [MIT](https://github.com/riii111/sabiql/blob/main/LICENSE)                              | Modern SQL client for PostgreSQL and MySQL                      |
...
| Name                                                           | Version   | License                                                                     | Comment                                                    |
|----------------------------------------------------------------|-----------|-----------------------------------------------------------------------------|------------------------------------------------------------|
| [`claude`](https://github.com/anthropics/claude-code)          | `2.1.114` | [Proprietary](https://www.anthropic.com/legal/terms)                        | Claude Code - Anthropic agentic coding                     |
| [`opencode`](https://github.com/anomalyco/opencode)            | `1.4.11`  | [MIT](https://github.com/anomalyco/opencode/blob/main/LICENSE)              | Terminal AI coding assistant                               |
| [`codex`](https://github.com/openai/codex)                     | `0.121.0` | [Apache-2.0](https://github.com/openai/codex/blob/main/LICENSE)             | OpenAI coding agent CLI                                    |
...
| [`uv`](https://github.com/astral-sh/uv)                        | `0.11.7`  | [MIT](https://github.com/astral-sh/uv/blob/main/LICENSE-MIT)                | Next-gen Python package manager                            |
