...
|------------------------------------------------------------------------------------------|----------|----------------------------------------------------------------------------------------|------------------------------------------|
| [`grafana`](https://github.com/grafana/grafana/)                                         | `12.4.2` | [AGPLv3](https://github.com/grafana/grafana/blob/main/LICENSE)                         | Observability and visualization platform |
...
| Name                                                                                                    | Version   | License                                                                                       | Comment                                       |
|---------------------------------------------------------------------------------------------------------|-----------|-----------------------------------------------------------------------------------------------|-----------------------------------------------|
| [`victoria-metrics`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                | `1.139.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | High-performance TSDB, Prometheus alternative |
| [`victoria-logs`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                   | `1.49.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | High-performance log storage and query engine |
...
| [`victoria-metrics-cluster`](https://github.com/VictoriaMetrics/VictoriaMetrics)                        | `1.139.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics distributed cluster           |
| [`vmutils`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.139.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics CLI utilities                 |
| [`vlogscli`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                        | `1.49.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaLogs interactive query client         |
| [`vlagent`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.49.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaLogs log collection agent             |
...
| [`grafana-victoriametrics-ds`](https://github.com/VictoriaMetrics/victoriametrics-datasource/releases/) | `0.23.4`  | [Apache-2.0](https://github.com/VictoriaMetrics/victoriametrics-datasource/blob/main/LICENSE) | VictoriaMetrics Grafana datasource            |
{.stretch-last}
...
| Name                                                                   | Version  | License                                                                           | Comment                                   |
|------------------------------------------------------------------------|----------|-----------------------------------------------------------------------------------|-------------------------------------------|
| [`prometheus`](https://github.com/prometheus/prometheus)               | `3.11.1` | [Apache-2.0](https://github.com/prometheus/prometheus/blob/main/LICENSE)          | Cloud-native monitoring & TSDB            |
...
| [`alertmanager`](https://github.com/prometheus/alertmanager)           | `0.32.0` | [Apache-2.0](https://github.com/prometheus/alertmanager/blob/main/LICENSE)        | Alert management & notification dispatch  |
...
| Name                                                    | Version          | License                                                                         | Comment                            |
|---------------------------------------------------------|------------------|---------------------------------------------------------------------------------|------------------------------------|
| [`minio`](https://github.com/pgsty/minio)               | `20260325000000` | [AGPLv3](https://github.com/minio/minio/blob/master/LICENSE)                    | FOSS S3 server, now built by pgsty |
...
| [`rustfs`](https://github.com/rustfs/rustfs)            | `1.0.0-alpha.91`       | [Apache-2.0](https://github.com/rustfs/rustfs/blob/main/LICENSE)                | FOSS MinIO, Alpha                  |
...
| [`seaweedfs`](https://github.com/seaweedfs/seaweedfs)   | `4.19`           | [Apache-2.0](https://github.com/seaweedfs/seaweedfs/blob/master/LICENSE)        | S3 for small files                 |
| [`rclone`](https://github.com/rclone/rclone/)           | `1.73.4`         | [MIT](https://github.com/rclone/rclone/blob/master/COPYING)                     | S3 command line tool               |
...
| [`duckdb`](https://github.com/duckdb/duckdb)                | `1.5.1`   | [MIT](https://github.com/duckdb/duckdb/blob/main/LICENSE)                          | Embedded OLAP                           |
...
| [`tigerbeetle`](https://github.com/tigerbeetle/tigerbeetle) | `0.16.78` | [Apache-2.0](https://github.com/tigerbeetle/tigerbeetle/blob/main/LICENSE)         | Financial OLTP                          |
...
| [`dblab`](https://github.com/danvergara/dblab)                                          | `0.37.1`   | [MIT](https://github.com/danvergara/dblab/blob/main/LICENSE)                            | Multi-database CLI tool                                         |
...
| [`sabiql`](https://github.com/riii111/sabiql)                                           | `1.10.0`    | [MIT](https://github.com/riii111/sabiql/blob/main/LICENSE)                              | Modern SQL client for PostgreSQL and MySQL                      |
| [`postgrest`](https://github.com/PostgREST/postgrest)                                   | `14.8`     | [MIT](https://github.com/PostgREST/postgrest/blob/main/LICENSE)                         | PostgreSQL RESTful API server                                   |
...
| [`hugo`](https://github.com/gohugoio/hugo)                                              | `0.160.1`  | [Apache-2.0](https://github.com/gohugoio/hugo/blob/master/LICENSE)                      | Fast static site generator                                      |
...
| [`maddy`](https://github.com/foxcpp/maddy)                                              | `0.9.2`    | [GPL-3.0](https://github.com/foxcpp/maddy/blob/master/LICENSE)                          | Lightweight mail server                                         |
{.stretch-last}
...
| Name                                                           | Version   | License                                                                     | Comment                                                    |
|----------------------------------------------------------------|-----------|-----------------------------------------------------------------------------|------------------------------------------------------------|
| [`claude`](https://github.com/anthropics/claude-code)          | `2.1.97`  | [Proprietary](https://www.anthropic.com/legal/terms)                        | Claude Code - Anthropic agentic coding                     |
| [`opencode`](https://github.com/opencode-ai/opencode)          | `1.4.0`  | [MIT](https://github.com/opencode-ai/opencode/blob/main/LICENSE)            | Terminal AI coding assistant                               |
| [`codex`](https://github.com/openai/codex)                     | `0.119.0-alpha.27` | [Apache-2.0](https://github.com/openai/codex/blob/main/LICENSE)             | OpenAI coding agent CLI                                    |
| [`crush`](https://github.com/charmbracelet/crush)              | `0.56.0`  | [FSL-1.1-MIT](https://github.com/charmbracelet/crush/blob/main/LICENSE.md)  | Charm's terminal AI coding agent                           |
| [`agentsview`](https://github.com/wesm/agentsview)             | `0.19.0`  | [MIT](https://github.com/wesm/agentsview/blob/main/LICENSE)                 | Browse and replay AI coding agent trajectories in terminal |
| [`code`](https://code.visualstudio.com/)                       | `1.115.0` | [MIT](https://github.com/microsoft/vscode/blob/main/LICENSE.txt)            | Visual Studio Code editor                                  |
| [`code-server`](https://github.com/coder/code-server)          | `4.115.0` | [MIT](https://github.com/coder/code-server/blob/main/LICENSE)               | VS Code in the browser                                     |
| [`genai-toolbox`](https://github.com/googleapis/genai-toolbox) | `0.30.0`  | [Apache-2.0](https://github.com/googleapis/genai-toolbox/blob/main/LICENSE) | Google database MCP server                                 |
| [`uv`](https://github.com/astral-sh/uv)                        | `0.11.5` | [MIT](https://github.com/astral-sh/uv/blob/main/LICENSE-MIT)                | Next-gen Python package manager                            |
| [`golang`](https://golang.org/)                                | `1.26.2`  | [BSD-3](https://github.com/golang/go/blob/master/LICENSE)                   | Go compiler                                                |
| [`nodejs`](https://nodejs.org/)                                | `24.14.1` | [MIT/Mixed](https://github.com/nodejs/node/blob/main/LICENSE)               | Server-side JavaScript runtime                             |
{.stretch-last}
