...
|------------------------------------------------------------------------------------------|----------|----------------------------------------------------------------------------------------|------------------------------------------|
| [`grafana`](https://github.com/grafana/grafana/)                                         | `13.0.0` | [AGPLv3](https://github.com/grafana/grafana/blob/main/LICENSE)                         | Observability and visualization platform |
...
| Name                                                                                                    | Version   | License                                                                                       | Comment                                       |
|---------------------------------------------------------------------------------------------------------|-----------|-----------------------------------------------------------------------------------------------|-----------------------------------------------|
| [`victoria-metrics`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                | `1.140.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | High-performance TSDB, Prometheus alternative |
...
| [`victoria-metrics-cluster`](https://github.com/VictoriaMetrics/VictoriaMetrics)                        | `1.140.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics distributed cluster           |
| [`vmutils`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.140.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics CLI utilities                 |
...
| Name                                                                   | Version  | License                                                                           | Comment                                   |
|------------------------------------------------------------------------|----------|-----------------------------------------------------------------------------------|-------------------------------------------|
| [`prometheus`](https://github.com/prometheus/prometheus)               | `3.11.2` | [Apache-2.0](https://github.com/prometheus/prometheus/blob/main/LICENSE)          | Cloud-native monitoring & TSDB            |
...
| [`rustfs`](https://github.com/rustfs/rustfs)            | `1.0.0-alpha.93`       | [Apache-2.0](https://github.com/rustfs/rustfs/blob/main/LICENSE)                | FOSS MinIO, Alpha                  |
...
| [`seaweedfs`](https://github.com/seaweedfs/seaweedfs)   | `4.20`           | [Apache-2.0](https://github.com/seaweedfs/seaweedfs/blob/master/LICENSE)        | S3 for small files                 |
...
| [`tigerbeetle`](https://github.com/tigerbeetle/tigerbeetle) | `0.17.0` | [Apache-2.0](https://github.com/tigerbeetle/tigerbeetle/blob/main/LICENSE)         | Financial OLTP                          |
...
| [`postgrest`](https://github.com/PostgREST/postgrest)                                   | `14.9`     | [MIT](https://github.com/PostgREST/postgrest/blob/main/LICENSE)                         | PostgreSQL RESTful API server                                   |
...
| Name                                                           | Version   | License                                                                     | Comment                                                    |
|----------------------------------------------------------------|-----------|-----------------------------------------------------------------------------|------------------------------------------------------------|
| [`claude`](https://github.com/anthropics/claude-code)          | `2.1.107` | [Proprietary](https://www.anthropic.com/legal/terms)                        | Claude Code - Anthropic agentic coding                     |
| [`opencode`](https://github.com/anomalyco/opencode)            | `1.4.3`   | [MIT](https://github.com/anomalyco/opencode/blob/main/LICENSE)              | Terminal AI coding assistant                               |
| [`codex`](https://github.com/openai/codex)                     | `0.121.0-alpha.7` | [Apache-2.0](https://github.com/openai/codex/blob/main/LICENSE)             | OpenAI coding agent CLI                                    |
| [`crush`](https://github.com/charmbracelet/crush)              | `0.57.0`  | [FSL-1.1-MIT](https://github.com/charmbracelet/crush/blob/main/LICENSE.md)  | Charm's terminal AI coding agent                           |
| [`agentsview`](https://github.com/wesm/agentsview)             | `0.22.2`  | [MIT](https://github.com/wesm/agentsview/blob/main/LICENSE)                 | Browse and replay AI coding agent trajectories in terminal |
...
| [`genai-toolbox`](https://github.com/googleapis/mcp-toolbox)   | `1.0.0`   | [Apache-2.0](https://github.com/googleapis/mcp-toolbox/blob/main/LICENSE)   | Google database MCP server                                 |
| [`uv`](https://github.com/astral-sh/uv)                        | `0.11.6`  | [MIT](https://github.com/astral-sh/uv/blob/main/LICENSE-MIT)                | Next-gen Python package manager                            |
