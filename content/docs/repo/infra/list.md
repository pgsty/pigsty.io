...
| Name                                                    | Version          | License                                                                         | Comment                            |
|---------------------------------------------------------|------------------|---------------------------------------------------------------------------------|------------------------------------|
| [`minio`](https://github.com/pgsty/minio)               | `20260321000000` | [AGPLv3](https://github.com/minio/minio/blob/master/LICENSE)                    | FOSS S3 server, now built by pgsty |
| [`mcli`](https://github.com/pgsty/mc)                   | `20260321000000` | [AGPLv3](https://github.com/pgsty/mc/blob/main/LICENSE)                         | FOSS S3 client, now built by pgsty |
