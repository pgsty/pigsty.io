...
|------------------------------------------------------------------------------------------|----------|----------------------------------------------------------------------------------------|------------------------------------------|
| [`grafana`](https://github.com/grafana/grafana/)                                         | `12.4.1` | [AGPLv3](https://github.com/grafana/grafana/blob/main/LICENSE)                         | Observability and visualization platform |
...
| [`grafana-infinity-ds`](https://github.com/grafana/grafana-infinity-datasource/)         | `3.7.4`  | [Apache-2.0](https://github.com/grafana/grafana-infinity-datasource/blob/main/LICENSE) | JSON/CSV/XML datasource support          |
...
| Name                                                                                                    | Version   | License                                                                                       | Comment                                       |
|---------------------------------------------------------------------------------------------------------|-----------|-----------------------------------------------------------------------------------------------|-----------------------------------------------|
| [`victoria-metrics`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                | `1.138.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | High-performance TSDB, Prometheus alternative |
| [`victoria-logs`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                   | `1.48.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | High-performance log storage and query engine |
| [`victoria-traces`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                 | `0.8.0`   | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | Distributed tracing backend                   |
| [`victoria-metrics-cluster`](https://github.com/VictoriaMetrics/VictoriaMetrics)                        | `1.138.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics distributed cluster           |
| [`vmutils`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.138.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics CLI utilities                 |
| [`vlogscli`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                        | `1.48.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaLogs interactive query client         |
| [`vlagent`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.48.0`  | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaLogs log collection agent             |
...
| [`grafana-victoriametrics-ds`](https://github.com/VictoriaMetrics/victoriametrics-datasource/releases/) | `0.23.1`  | [Apache-2.0](https://github.com/VictoriaMetrics/victoriametrics-datasource/blob/main/LICENSE) | VictoriaMetrics Grafana datasource            |
{.stretch-last}
...
| Name                                                                   | Version  | License                                                                           | Comment                                   |
|------------------------------------------------------------------------|----------|-----------------------------------------------------------------------------------|-------------------------------------------|
| [`prometheus`](https://github.com/prometheus/prometheus)               | `3.10.0`  | [Apache-2.0](https://github.com/prometheus/prometheus/blob/main/LICENSE)          | Cloud-native monitoring & TSDB            |
...
| [`mongodb_exporter`](https://github.com/percona/mongodb_exporter)         | `0.49.0` | [Apache-2.0](https://github.com/percona/mongodb_exporter/blob/main/LICENSE)           | Expose mongodb metrics             |
...
| [`vector`](https://github.com/vectordotdev/vector/releases)               | `0.54.0` | [MPL-2.0](https://github.com/vectordotdev/vector/blob/master/LICENSE)                 | Versatile log collector            |
{.stretch-last}
...
| Name                                                    | Version          | License                                                                         | Comment                            |
|---------------------------------------------------------|------------------|---------------------------------------------------------------------------------|------------------------------------|
| [`minio`](https://github.com/pgsty/minio)               | `20260314120000` | [AGPLv3](https://github.com/minio/minio/blob/master/LICENSE)                    | FOSS S3 server, now built by pgsty |
| [`mcli`](https://github.com/pgsty/mc)                   | `20260313085732` | [AGPLv3](https://github.com/pgsty/mc/blob/main/LICENSE)                        | FOSS S3 client, now built by pgsty |
| [`rustfs`](https://github.com/rustfs/rustfs)            | `alpha.89`       | [Apache-2.0](https://github.com/rustfs/rustfs/blob/main/LICENSE)                | FOSS MinIO, Alpha                  |
...
| [`seaweedfs`](https://github.com/seaweedfs/seaweedfs)   | `4.17`           | [Apache-2.0](https://github.com/seaweedfs/seaweedfs/blob/master/LICENSE)        | S3 for small files                 |
| [`rclone`](https://github.com/rclone/rclone/)           | `1.73.2`         | [MIT](https://github.com/rclone/rclone/blob/master/COPYING)                     | S3 command line tool               |
...
| Name                                                        | Version   | License                                                                            | Comment                                 |
|-------------------------------------------------------------|-----------|------------------------------------------------------------------------------------|-----------------------------------------|
| [`etcd`](https://github.com/etcd-io/etcd)                   | `3.6.9`   | [Apache-2.0](https://github.com/etcd-io/etcd/blob/main/LICENSE)                    | Fault-tolerant distributed coordination |
| [`kafka`](https://github.com/apache/kafka)                  | `4.2.0`   | [Apache-2.0](https://github.com/apache/kafka/blob/trunk/LICENSE)                   | Message queue                           |
| [`duckdb`](https://github.com/duckdb/duckdb)                | `1.5.0`   | [MIT](https://github.com/duckdb/duckdb/blob/main/LICENSE)                          | Embedded OLAP                           |
...
| [`tigerbeetle`](https://github.com/tigerbeetle/tigerbeetle) | `0.16.77` | [Apache-2.0](https://github.com/tigerbeetle/tigerbeetle/blob/main/LICENSE)         | Financial OLTP                          |
...
| [`pgschema`](https://github.com/pgplex/pgschema)                                        | `1.7.4`    | [Apache-2.0](https://github.com/pgplex/pgschema/blob/main/LICENSE)                      | Terraform-style declarative Postgres schema migration CLI |
...
| [`tigerfs`](https://github.com/timescale/tigerfs)                                        | `0.5.0`    | [MIT](https://github.com/timescale/tigerfs/blob/main/LICENSE)                           | Mount PostgreSQL as a filesystem              |
...
| [`rainfrog`](https://github.com/achristmascarl/rainfrog)                                | `0.3.17`   | [MIT](https://github.com/achristmascarl/rainfrog/blob/main/LICENSE)                     | Terminal Postgres database management tool    |
...
| [`vray`](https://github.com/v2fly/v2ray-core)                                           | `5.47.0`   | [MIT](https://github.com/v2fly/v2ray-core/blob/master/LICENSE)                          | Build proxies to bypass network restrictions  |
...
| [`sabiql`](https://github.com/riii111/sabiql)                                           | `1.8.2`    | [MIT](https://github.com/riii111/sabiql/blob/main/LICENSE)                              | Modern SQL client for PostgreSQL and MySQL |
| [`postgrest`](https://github.com/PostgREST/postgrest)                                   | `14.7`     | [MIT](https://github.com/PostgREST/postgrest/blob/main/LICENSE)                         | PostgreSQL RESTful API server                 |
| [`npgsqlrest`](https://github.com/vb-consulting/NpgsqlRest)                             | `3.11.1`    | [MIT](https://github.com/vb-consulting/NpgsqlRest/blob/master/LICENSE.md)               | .NET PostgreSQL REST API generator            |
...
| [`hugo`](https://github.com/gohugoio/hugo)                                              | `0.158.0`  | [Apache-2.0](https://github.com/gohugoio/hugo/blob/master/LICENSE)                      | Fast static site generator                    |
...
| Name                                                           | Version   | License                                                                     | Comment                                |
|----------------------------------------------------------------|-----------|-----------------------------------------------------------------------------|----------------------------------------|
| [`claude`](https://github.com/anthropics/claude-code)          | `2.1.81`  | [Proprietary](https://www.anthropic.com/legal/terms)                        | Claude Code - Anthropic agentic coding |
| [`opencode`](https://github.com/opencode-ai/opencode)          | `1.2.27`  | [MIT](https://github.com/opencode-ai/opencode/blob/main/LICENSE)            | Terminal AI coding assistant           |
| [`codex`](https://github.com/openai/codex)                     | `0.116.0` | [Apache-2.0](https://github.com/openai/codex/blob/main/LICENSE)             | OpenAI coding agent CLI               |
| [`crush`](https://github.com/charmbracelet/crush)              | `0.51.2`  | [FSL-1.1-MIT](https://github.com/charmbracelet/crush/blob/main/LICENSE.md)  | Charm's terminal AI coding agent      |
| [`agentsview`](https://github.com/wesm/agentsview)             | `0.15.0`  | [MIT](https://github.com/wesm/agentsview/blob/main/LICENSE)                 | Browse and replay AI coding agent trajectories in terminal |
| [`code`](https://code.visualstudio.com/)                       | `1.112.0` | [MIT](https://github.com/microsoft/vscode/blob/main/LICENSE.txt)            | Visual Studio Code editor              |
| [`code-server`](https://github.com/coder/code-server)          | `4.112.0` | [MIT](https://github.com/coder/code-server/blob/main/LICENSE)               | VS Code in the browser                 |
...
| [`uv`](https://github.com/astral-sh/uv)                        | `0.10.12`  | [MIT](https://github.com/astral-sh/uv/blob/main/LICENSE-MIT)                | Next-gen Python package manager        |
| [`golang`](https://golang.org/)                                | `1.26.1`  | [BSD-3](https://github.com/golang/go/blob/master/LICENSE)                   | Go compiler                            |
