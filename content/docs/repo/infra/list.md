...
| [`grafana-infinity-ds`](https://github.com/grafana/grafana-infinity-datasource/)         | `3.6.0`  | [Apache-2.0](https://github.com/grafana/grafana-infinity-datasource/blob/main/LICENSE) | JSON/CSV/XML datasource support          |
...
| Name                                                                                                    | Version   | License                                                                                       | Comment                                       |
|---------------------------------------------------------------------------------------------------------|-----------|-----------------------------------------------------------------------------------------------|-----------------------------------------------|
| [`victoria-metrics`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                | `1.132.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | High-performance TSDB, Prometheus alternative |
...
| [`victoria-metrics-cluster`](https://github.com/VictoriaMetrics/VictoriaMetrics)                        | `1.132.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics distributed cluster           |
| [`vmutils`](https://github.com/VictoriaMetrics/VictoriaMetrics)                                         | `1.132.0` | [Apache-2.0](https://github.com/VictoriaMetrics/VictoriaMetrics/blob/master/LICENSE)          | VictoriaMetrics CLI utilities                 |
...
| [`grafana-victorialogs-ds`](https://github.com/VictoriaMetrics/victorialogs-datasource/releases/)       | `0.23.2`  | [Apache-2.0](https://github.com/VictoriaMetrics/victorialogs-datasource/blob/main/LICENSE)    | VictoriaLogs Grafana datasource               |
| [`grafana-victoriametrics-ds`](https://github.com/VictoriaMetrics/victoriametrics-datasource/releases/) | `0.19.7`  | [Apache-2.0](https://github.com/VictoriaMetrics/victoriametrics-datasource/blob/main/LICENSE) | VictoriaMetrics Grafana datasource            |
{.stretch-last}
...
| Name                                                                   | Version  | License                                                                           | Comment                                   |
|------------------------------------------------------------------------|----------|-----------------------------------------------------------------------------------|-------------------------------------------|
| [`prometheus`](https://github.com/prometheus/prometheus)               | `3.8.1`  | [Apache-2.0](https://github.com/prometheus/prometheus/blob/main/LICENSE)          | Cloud-native monitoring & TSDB            |
...
| [`rustfs`](https://github.com/rustfs/rustfs)            | `1.0.0-a71`      | [Apache-2.0](https://github.com/rustfs/rustfs/blob/main/LICENSE)                | FOSS MinIO, Alpha                  |
...
| [`seaweedfs`](https://github.com/seaweedfs/seaweedfs)   | `4.01`           | [Apache-2.0](https://github.com/seaweedfs/seaweedfs/blob/master/LICENSE)        | S3 for small files                 |
...
| [`kafka`](https://github.com/apache/kafka)                  | `4.0.0`   | [Apache-2.0](https://github.com/apache/kafka/blob/trunk/LICENSE)                   | Message queue                           |
...
| [`tigerbeetle`](https://github.com/tigerbeetle/tigerbeetle) | `0.16.65` | [Apache-2.0](https://github.com/tigerbeetle/tigerbeetle/blob/main/LICENSE)         | Financial OLTP                          |
...
| Name                                                                                    | Version  | License                                                                                 | Comment                                       |
|-----------------------------------------------------------------------------------------|----------|-----------------------------------------------------------------------------------------|-----------------------------------------------|
| [`pig`](https://github.com/pgsty/pig)                                                   | `0.9.0`  | [Apache-2.0](https://github.com/pgsty/pig/blob/main/LICENSE)                            | PG package manager                            |
