...
You can also download `pig` installation packages (`RPM`/`DEB`/tarball) directly from the Pigsty repository: [GitHub v1.4.0 Stable Release Page](https://github.com/pgsty/pig/releases/tag/v1.4.0)
