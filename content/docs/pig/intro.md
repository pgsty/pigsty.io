...
This is exactly why **Pig** was created. Developed in Go, Pig is dedicated to one-stop management of Postgres and its [{{< param pgext_count >}} packaged extensions](/ext/list).
