...
The latest stable version is [v1.3.4](https://github.com/pgsty/pig/releases/tag/v1.3.4).

|     Version     |    Date    | Summary                                                            |                           GitHub                           |
|:---------------:|:----------:|--------------------------------------------------------------------|:----------------------------------------------------------:|
| [v1.3.4](#v134) | 2026-04-14 | 504 available extensions                                        | [v1.3.4](https://github.com/pgsty/pig/releases/tag/v1.3.4) |
