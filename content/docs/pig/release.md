...
The latest stable version is [v1.1.0](https://github.com/pgsty/pig/releases/tag/v1.1.0).

|     Version     |    Date    | Summary                                         |                           GitHub                           |
|:---------------:|:----------:|-------------------------------------------------|:----------------------------------------------------------:|
| [v1.1.0](#v110) | 2026-02-12 | 451 extensions, Agent-Native CLI framework      | [v1.0.0](https://github.com/pgsty/pig/releases/tag/v1.1.0) |
