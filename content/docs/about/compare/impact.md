...
Sorted by GitHub stars in descending order. Last updated: 2026-03-12

| Project                                                                                                   |                                     Star                                     | Vendor        | Type         | License     | Summary                                                                |
|-----------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------:|---------------|--------------|-------------|------------------------------------------------------------------------|
| [CloudNativePG](https://github.com/cloudnative-pg/cloudnative-pg)                                         |   [**8198**](https://github.com/cloudnative-pg/cloudnative-pg/stargazers)    | EDB           | K8S Native   | Apache-2.0  | Mainstream PG Operator without Patroni dependency                      |
| [Zalando Postgres Operator](https://github.com/zalando/postgres-operator)                                 |     [**5107**](https://github.com/zalando/postgres-operator/stargazers)      | Zalando       | K8S Native   | MIT         | Long-standing Patroni/Spilo architecture operator                      |
| [Pigsty](https://github.com/pgsty/pigsty)                                                                 |            [**4875**](https://github.com/pgsty/pigsty/stargazers)            | **PGSTY**     | Linux Native | Apache-2.0  | Ansible-driven integrated PostgreSQL distribution                      |
| [Stolon](https://github.com/sorintlab/stolon)                                                             |          [**4810**](https://github.com/sorintlab/stolon/stargazers)          | Sorint.lab    | K8S Native   | Apache-2.0  | Early PG HA orchestration framework (non-typical operator)             |
| [PGO](https://github.com/CrunchyData/postgres-operator)                                                   |   [**4376**](https://github.com/CrunchyData/postgres-operator/stargazers)    | Crunchy Data  | K8S Native   | Apache-2.0  | Production-grade operator with backup and monitoring                   |
| [Autobase](https://github.com/vitabaks/autobase)                                                          |         [**4024**](https://github.com/vitabaks/autobase/stargazers)          | vitabaks      | Linux Native | MIT         | Automated deployment for Patroni/etcd/Consul                           |
| [KubeBlocks](https://github.com/apecloud/kubeblocks)                                                      |        [**2993**](https://github.com/apecloud/kubeblocks/stargazers)         | ApeCloud      | K8S Native   | AGPL-3.0    | Unified multi-database operator platform                               |
| [StackGres](https://github.com/ongres/stackgres)                                                          |          [**1377**](https://github.com/ongres/stackgres/stargazers)          | OnGres        | K8S Native   | AGPL-3.0    | Integrated PG operator with CRD/CLI/Web UI                             |
...
| [pgEdge](https://github.com/pgEdge)                                                                       |            [**681**](https://github.com/pgEdge/spock/stargazers)             | pgEdge        | Linux Native | PostgreSQL  | Distributed PG distribution focused on Spock multi-master replication  |
