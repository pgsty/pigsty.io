...
- [Rich Extensions](#rich-extensions): Providing unparalleled 451 extensions with out-of-the-box distributed, time-series, geospatial, graph, vector, multi-modal database capabilities.
...
- Out-of-the-box [PostgreSQL](https://www.postgresql.org/) distribution, deeply integrating 451 [extension plugins](/docs/ref/extension) for geospatial, time-series, distributed, graph, vector, search, and AI!
