...
Previously, Pigsty could only run on CentOS 7, but now it covers all mainstream Linux distributions (EL, Debian, Ubuntu) across 16 operating system platforms. Supported PG major versions cover 13-18, and we maintain and integrate 510 extension plugins in the PG ecosystem.
