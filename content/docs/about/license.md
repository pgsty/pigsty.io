...
title: License
weight: 135
description: Pigsty's open-source licenses — Apache-2.0 and CC BY 4.0
...
For {{< param pgext_count >}} PostgreSQL extension plugin licenses, refer to [**PostgreSQL Extension License List**](/ext/license/).
...
|   MINIO    | [Silo](https://github.com/pgsty/silo)                            | [AGPLv3](https://github.com/pgsty/silo/blob/main/LICENSE)                                                 | Default S3-compatible object storage service in current source |  **Optional**   |
|   MINIO    | [MinIO](https://github.com/pgsty/minio)                          | [AGPLv3](https://github.com/pgsty/minio/blob/master/LICENSE)                                              | Compatibility with existing MinIO deployments |  **Optional**   |
|   MINIO    | [RustFS](https://github.com/rustfs/rustfs)                       | [Apache License 2.0](https://github.com/rustfs/rustfs/blob/main/LICENSE)                                  | Optional S3-compatible object storage backend |  **Optional**   |
