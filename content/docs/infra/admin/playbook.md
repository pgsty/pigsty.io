...
Pigsty uses **idempotent** Ansible playbooks for management and control. Running playbooks requires `ansible-playbook` to be in the system PATH; users must first [install Ansible](/docs/infra/admin/ansible/#installation) before executing playbooks.
