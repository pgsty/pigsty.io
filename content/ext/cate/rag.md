...
[**`pgmnemo`**](/ext/e/pgmnemo) - `0.20.0` : Single-plan multimodal agent memory for PostgreSQL
...
[**`pgcontext`**](/ext/e/pgcontext) - `0.3.0` : Vector, filter-aware HNSW, and hybrid retrieval over authoritative PostgreSQL tables.
