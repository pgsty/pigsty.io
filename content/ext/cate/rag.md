...
There are **10** extensions in **10** packages.
...
| [`vectorize`](/ext/e/vectorize) | [`pg_vectorize`](https://github.com/ChuckHend/pg_vectorize) | `0.26.0` | <a class="ext-badge ext-badge--license postgresql" href="/ext/license#postgresql">PostgreSQL</a> | <a class="ext-badge ext-badge--lang rust" href="/ext/language#rust">Rust</a> | The simplest way to do vector search on Postgres |
...
[**`pg_vectorize`**](/ext/e/vectorize) - `0.26.0` : The simplest way to do vector search on Postgres
