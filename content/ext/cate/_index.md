...
| <a class="ext-badge ext-badge--cate rag" href="/ext/cate/rag">RAG</a> | 13 | 13 | Vector Database with Ivfflat, HNSW, DiskANN Indexes, AI & ML in SQL interface, Similarity Funcs, etc...  |
...
| <a class="ext-badge ext-badge--cate lang" href="/ext/cate/lang">LANG</a> | 37 | 24 | Develop, Test, Package, and Deliver Stored Procedures written in various PL/Languages: Java, Js, Lua, R, Sh, PRQL, ... |
...
| <a class="ext-badge ext-badge--cate admin" href="/ext/cate/admin">ADMIN</a> | 45 | 43 | Utilities for Bloat Control, DirtyRead, BufferInspect, DDL Generate, ChecksumVerify, Permission, Priority, Catalog,... |
...
| <a class="ext-badge ext-badge--cate sec" href="/ext/cate/sec">SEC</a> | 37 | 37 | Auditing Logs, Enforce Passwords, Keep Secrets, TDE, SM Algorithm, Login Hooks, Log Errors, Extension White List, ... |
