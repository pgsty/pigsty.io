...
[**`pg_profile`**](/ext/e/pg_profile) - `4.15` : PostgreSQL load profile repository and report builder
...
| **Item** | **Value** | **OS** | **x86_64** | **aarch64** |
|:---:|:---|:---:|:---:|:---:|
| **Extension** | [`pg_statviz`](/ext/e/pg_statviz) | **el8** | {{< pgvers "16,15,14" >}} | {{< pgvers "16,15,14" >}} |
| **Package** | [`pg_statviz`](https://github.com/vyruss/pg_statviz) | **el9** | {{< pgvers "16,15,14" >}} | {{< pgvers "16,15,14" >}} |
...
[**`pg_track_optimizer`**](/ext/e/pg_track_optimizer) - `0.9.2` : Track planning decisions in comparison with  execution reality
