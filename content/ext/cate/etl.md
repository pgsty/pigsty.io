...
| [`pgmqtt`](/ext/e/pgmqtt) | [`pgmqtt`](https://github.com/RayElg/pgmqtt) | `0.3.0` | <a class="ext-badge ext-badge--license elv2" href="/ext/license#elv2">ELv2</a> | <a class="ext-badge ext-badge--lang rust" href="/ext/language#rust">Rust</a> | CDC-to-MQTT broker for PostgreSQL |
...
| **Item** | **Value** | **OS** | **x86_64** | **aarch64** |
|:---:|:---|:---:|:---:|:---:|
| **Extension** | [`pglogical_ticker`](/ext/e/pglogical_ticker) | **el8** | {{< pgvers "18" >}} | {{< pgvers "18" >}} |
| **Package** | [`pglogical_ticker`](https://github.com/enova/pglogical_ticker) | **el9** | {{< pgvers "18" >}} | {{< pgvers "18" >}} |
...
[**`pgmqtt`**](/ext/e/pgmqtt) - `0.3.0` : CDC-to-MQTT broker for PostgreSQL
