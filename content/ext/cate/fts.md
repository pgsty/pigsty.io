...
|:---------|:-------|:--------:|:----------:|:--------:|:---------|
| [`pg_search`](/ext/e/pg_search) | [`pg_search`](https://github.com/paradedb/paradedb/tree/dev/pg_search) | `0.24.0` | <a class="ext-badge ext-badge--license agpl30" href="/ext/license#agpl30">AGPL-3.0</a> | <a class="ext-badge ext-badge--lang rust" href="/ext/language#rust">Rust</a> | Full text search for PostgreSQL using BM25 |
...
| [`biscuit`](/ext/e/biscuit) | [`pg_biscuit`](https://github.com/CrystallineCore/Biscuit) | `2.3.0` | <a class="ext-badge ext-badge--license mit" href="/ext/license#mit">MIT</a> | <a class="ext-badge ext-badge--lang c" href="/ext/language#c">C</a> | IAM-LIKE pattern matching with bitmap indexing |
...
[**`pg_search`**](/ext/e/pg_search) - `0.24.0` : Full text search for PostgreSQL using BM25
...
[**`pg_biscuit`**](/ext/e/biscuit) - `2.3.0` : IAM-LIKE pattern matching with bitmap indexing
...
[**`pg_pinyin`**](/ext/e/pg_pinyin) - `0.0.4` : Pinyin romanization and search helpers for PostgreSQL
...
[**`pg_kazsearch`**](/ext/e/pg_kazsearch) - `2.2.0` : Kazakh full-text search extension for PostgreSQL
