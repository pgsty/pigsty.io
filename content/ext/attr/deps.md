...
**129** extensions depend on other extensions, **76** extensions are depended upon by others.
...
| [`provsql`](/ext/e/provsql) | [`uuid-ossp`](/ext/e/uuid-ossp) | Semiring provenance and probability management for PostgreSQL |
...
| [`plpgsql_check`](/ext/e/plpgsql_check) | [`plpgsql`](/ext/e/plpgsql) | Additional validation, profiling, and diagnostics for PL/pgSQL functions |
| [`pgsqlmock`](/ext/e/pgsqlmock) | [`plpgsql`](/ext/e/plpgsql) [`pgtap`](/ext/e/pgtap) | Mocking and faking helpers for PostgreSQL unit tests |
| [`jsonb_plruby`](/ext/e/jsonb_plruby) | [`plruby`](/ext/e/plruby) | Transform between jsonb and native Ruby data for PL/Ruby |
| [`hstore_plruby`](/ext/e/hstore_plruby) | [`hstore`](/ext/e/hstore) [`plruby`](/ext/e/plruby) | Transform between hstore and Ruby Hashes for PL/Ruby |
| [`ltree_plruby`](/ext/e/ltree_plruby) | [`ltree`](/ext/e/ltree) [`plruby`](/ext/e/plruby) | Transform between ltree and Ruby Arrays for PL/Ruby |
...
| [`pg_readme`](/ext/e/pg_readme) | [`hstore`](/ext/e/hstore) | Generate a Markdown README from PostgreSQL COMMENT objects |
...
| [`cat_tools`](/ext/e/cat_tools) | [`plpgsql`](/ext/e/plpgsql) | Tools for interfacing with the PostgreSQL catalog |
...
| [`citus`](/ext/e/citus) | [`cigration`](/ext/e/cigration) [`documentdb_distributed`](/ext/e/documentdb_distributed) | Distributed PostgreSQL as an extension |
...
| [`plruby`](/ext/e/plruby) | [`hstore_plruby`](/ext/e/hstore_plruby) [`jsonb_plruby`](/ext/e/jsonb_plruby) [`ltree_plruby`](/ext/e/ltree_plruby) | Embed MRI Ruby as an untrusted PostgreSQL procedural language |
...
| [`cat_tools`](/ext/e/cat_tools) | [`extension_drop`](/ext/e/extension_drop) [`object_reference`](/ext/e/object_reference) | Tools for interfacing with the PostgreSQL catalog |
