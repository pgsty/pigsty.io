...
| [`decoderbufs`](/ext/e/decoderbufs) | [`decoderbufs`](https://github.com/debezium/postgres-decoderbufs) | `3.6.0` | `--sL---` | Logical decoding plugin that delivers WAL stream changes using a Protocol Buffer format |
