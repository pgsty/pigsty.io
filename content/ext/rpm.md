...
There are **458** PostgreSQL extensions available on EL systems, in **381** packages.

**15** packages are EL exclusive, **3** DEB packages are missing corresponding RPM packages.
