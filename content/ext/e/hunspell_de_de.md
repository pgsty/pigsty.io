...
| **Related** | [`hunspell_cs_cz`](/ext/e/hunspell_cs_cz) [`hunspell_en_us`](/ext/e/hunspell_en_us) [`hunspell_fr`](/ext/e/hunspell_fr) [`hunspell_nl_nl`](/ext/e/hunspell_nl_nl) [`hunspell_ne_np`](/ext/e/hunspell_ne_np) [`hunspell_nn_no`](/ext/e/hunspell_nn_no) [`hunspell_pt_pt`](/ext/e/hunspell_pt_pt) [`hunspell_ru_ru`](/ext/e/hunspell_ru_ru) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
@ u26.x86_64 18 postgresql-18-hunspell-de-de postgresql-18-hunspell-de-de_1.0-1PIGSTY~resolute_amd64.deb pigsty 1.0 950.4KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-de-de/postgresql-18-hunspell-de-de_1.0-1PIGSTY~resolute_amd64.deb
@ u26.aarch64 18 postgresql-18-hunspell-de-de postgresql-18-hunspell-de-de_1.0-1PIGSTY~resolute_arm64.deb pigsty 1.0 950.4KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-de-de/postgresql-18-hunspell-de-de_1.0-1PIGSTY~resolute_arm64.deb
...
@ u26.x86_64 17 postgresql-17-hunspell-de-de postgresql-17-hunspell-de-de_1.0-1PIGSTY~resolute_amd64.deb pigsty 1.0 951.3KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-de-de/postgresql-17-hunspell-de-de_1.0-1PIGSTY~resolute_amd64.deb
@ u26.aarch64 17 postgresql-17-hunspell-de-de postgresql-17-hunspell-de-de_1.0-1PIGSTY~resolute_arm64.deb pigsty 1.0 951.3KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-de-de/postgresql-17-hunspell-de-de_1.0-1PIGSTY~resolute_arm64.deb
...
@ u26.x86_64 16 postgresql-16-hunspell-de-de postgresql-16-hunspell-de-de_1.0-1PIGSTY~resolute_amd64.deb pigsty 1.0 950.9KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-de-de/postgresql-16-hunspell-de-de_1.0-1PIGSTY~resolute_amd64.deb
@ u26.aarch64 16 postgresql-16-hunspell-de-de postgresql-16-hunspell-de-de_1.0-1PIGSTY~resolute_arm64.deb pigsty 1.0 950.9KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-de-de/postgresql-16-hunspell-de-de_1.0-1PIGSTY~resolute_arm64.deb
...
@ u26.x86_64 15 postgresql-15-hunspell-de-de postgresql-15-hunspell-de-de_1.0-1PIGSTY~resolute_amd64.deb pigsty 1.0 951.2KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-de-de/postgresql-15-hunspell-de-de_1.0-1PIGSTY~resolute_amd64.deb
@ u26.aarch64 15 postgresql-15-hunspell-de-de postgresql-15-hunspell-de-de_1.0-1PIGSTY~resolute_arm64.deb pigsty 1.0 951.2KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-de-de/postgresql-15-hunspell-de-de_1.0-1PIGSTY~resolute_arm64.deb
...
@ u26.x86_64 14 postgresql-14-hunspell-de-de postgresql-14-hunspell-de-de_1.0-1PIGSTY~resolute_amd64.deb pigsty 1.0 951.0KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-de-de/postgresql-14-hunspell-de-de_1.0-1PIGSTY~resolute_amd64.deb
@ u26.aarch64 14 postgresql-14-hunspell-de-de postgresql-14-hunspell-de-de_1.0-1PIGSTY~resolute_arm64.deb pigsty 1.0 951.0KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-de-de/postgresql-14-hunspell-de-de_1.0-1PIGSTY~resolute_arm64.deb
{{< /pgext_matrix >}}

## Build

You can build the RPM / DEB packages for `hunspell_de_de` using `pig build`:

```bash
pig build pkg hunspell_de_de         # build RPM / DEB packages
```


## Install

You can install `hunspell_de_de` directly. First, make sure the [**PGDG**](/docs/repo/pgdg) and [**PIGSTY**](/docs/repo/pgsql) repositories are added and enabled:
...
{{% tab header="Install" %}}
```bash
pig install hunspell_de_de;          # Install for current active PG version
```
{{% /tab %}}
{{% tab header="pig" %}}
```bash
