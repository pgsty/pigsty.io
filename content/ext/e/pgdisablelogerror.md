...
| **Related** | [`pg_stat_log`](/ext/e/pg_stat_log) [`pgelog`](/ext/e/pgelog) [`logerrors`](/ext/e/logerrors) [`pgaudit`](/ext/e/pgaudit) [`pg_sqlog`](/ext/e/pg_sqlog) [`log_fdw`](/ext/e/log_fdw) [`pg_auth_mon`](/ext/e/pg_auth_mon) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
