...
| **Related** | [`pgauditlogtofile`](/ext/e/pgauditlogtofile) [`set_user`](/ext/e/set_user) [`pg_permissions`](/ext/e/pg_permissions) [`pg_auth_mon`](/ext/e/pg_auth_mon) [`pg_auditor`](/ext/e/pg_auditor) [`safeupdate`](/ext/e/safeupdate) [`pg_drop_events`](/ext/e/pg_drop_events) [`table_log`](/ext/e/table_log) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
