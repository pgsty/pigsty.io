...
| **Related** | [`hunspell_cs_cz`](/ext/e/hunspell_cs_cz) [`hunspell_de_de`](/ext/e/hunspell_de_de) [`hunspell_en_us`](/ext/e/hunspell_en_us) [`hunspell_fr`](/ext/e/hunspell_fr) [`hunspell_ne_np`](/ext/e/hunspell_ne_np) [`hunspell_nn_no`](/ext/e/hunspell_nn_no) [`hunspell_pt_pt`](/ext/e/hunspell_pt_pt) [`hunspell_ru_ru`](/ext/e/hunspell_ru_ru) |
|:--------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
@ u26.x86_64 18 postgresql-18-hunspell-nl-nl postgresql-18-hunspell-nl-nl_1.0-1PIGSTY~resolute_amd64.deb pigsty 1.0 537.7KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-nl-nl/postgresql-18-hunspell-nl-nl_1.0-1PIGSTY~resolute_amd64.deb
@ u26.aarch64 18 postgresql-18-hunspell-nl-nl postgresql-18-hunspell-nl-nl_1.0-1PIGSTY~resolute_arm64.deb pigsty 1.0 537.7KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-nl-nl/postgresql-18-hunspell-nl-nl_1.0-1PIGSTY~resolute_arm64.deb
...
@ u26.x86_64 17 postgresql-17-hunspell-nl-nl postgresql-17-hunspell-nl-nl_1.0-1PIGSTY~resolute_amd64.deb pigsty 1.0 536.6KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-nl-nl/postgresql-17-hunspell-nl-nl_1.0-1PIGSTY~resolute_amd64.deb
@ u26.aarch64 17 postgresql-17-hunspell-nl-nl postgresql-17-hunspell-nl-nl_1.0-1PIGSTY~resolute_arm64.deb pigsty 1.0 536.6KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-nl-nl/postgresql-17-hunspell-nl-nl_1.0-1PIGSTY~resolute_arm64.deb
...
@ u26.x86_64 16 postgresql-16-hunspell-nl-nl postgresql-16-hunspell-nl-nl_1.0-1PIGSTY~resolute_amd64.deb pigsty 1.0 536.5KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-nl-nl/postgresql-16-hunspell-nl-nl_1.0-1PIGSTY~resolute_amd64.deb
@ u26.aarch64 16 postgresql-16-hunspell-nl-nl postgresql-16-hunspell-nl-nl_1.0-1PIGSTY~resolute_arm64.deb pigsty 1.0 536.5KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-nl-nl/postgresql-16-hunspell-nl-nl_1.0-1PIGSTY~resolute_arm64.deb
...
@ u26.x86_64 15 postgresql-15-hunspell-nl-nl postgresql-15-hunspell-nl-nl_1.0-1PIGSTY~resolute_amd64.deb pigsty 1.0 536.9KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-nl-nl/postgresql-15-hunspell-nl-nl_1.0-1PIGSTY~resolute_amd64.deb
@ u26.aarch64 15 postgresql-15-hunspell-nl-nl postgresql-15-hunspell-nl-nl_1.0-1PIGSTY~resolute_arm64.deb pigsty 1.0 536.9KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-nl-nl/postgresql-15-hunspell-nl-nl_1.0-1PIGSTY~resolute_arm64.deb
...
@ u26.x86_64 14 postgresql-14-hunspell-nl-nl postgresql-14-hunspell-nl-nl_1.0-1PIGSTY~resolute_amd64.deb pigsty 1.0 536.9KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-nl-nl/postgresql-14-hunspell-nl-nl_1.0-1PIGSTY~resolute_amd64.deb
@ u26.aarch64 14 postgresql-14-hunspell-nl-nl postgresql-14-hunspell-nl-nl_1.0-1PIGSTY~resolute_arm64.deb pigsty 1.0 536.9KiB https://repo.pigsty.io/apt/pgsql/resolute/pool/main/h/hunspell-nl-nl/postgresql-14-hunspell-nl-nl_1.0-1PIGSTY~resolute_arm64.deb
{{< /pgext_matrix >}}

## Build

You can build the RPM / DEB packages for `hunspell_nl_nl` using `pig build`:

```bash
pig build pkg hunspell_nl_nl         # build RPM / DEB packages
```


## Install

You can install `hunspell_nl_nl` directly. First, make sure the [**PGDG**](/docs/repo/pgdg) and [**PIGSTY**](/docs/repo/pgsql) repositories are added and enabled:
...
{{% tab header="Install" %}}
```bash
pig install hunspell_nl_nl;          # Install for current active PG version
```
{{% /tab %}}
{{% tab header="pig" %}}
```bash
