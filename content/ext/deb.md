...
There are **518** PostgreSQL extensions available on Debian/Ubuntu systems, in **432** packages.

**2** packages are Debian/Ubuntu exclusive, **13** RPM packages are missing corresponding DEB packages.
