...
There are **449** PostgreSQL extensions available on Debian/Ubuntu systems, in **369** packages.

**3** packages are Debian/Ubuntu exclusive, **15** RPM packages are missing corresponding DEB packages.
