...
description: >
  Extensions are the soul of PostgreSQL. Pigsty builds, packages, collects, and integrates 572 PG ecosystem extensions for out-of-the-box use.
weight: 20
outputs:
  - HTML
cascade:
...
- [**Packaged Extension Catalog**](/ext/list): Browse detailed information, usage, metadata, download links and docs for [**572 packaged extensions**](/ext/list)
...
- **Quantity**: Unparalleled extension count: **572 packaged extensions**, the most in the PG extension ecosystem
