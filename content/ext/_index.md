...
description: >
  Extensions are the soul of PostgreSQL. Pigsty builds, collects, and integrates 504 PG ecosystem extensions for out-of-the-box use.
weight: 20
outputs:
  - HTML
cascade:
...
- [**Extension Catalog**](/ext/list): Browse detailed information, usage, metadata, download links and docs for [**504**](/ext/list) extensions
- [**Extension Repository**](/docs/repo/pgsql): Get pre-built RPM/DEB binary packages, available on [**14 Linux systems**](/ext/os)
...
- **Quantity**: Unparalleled extension count: **504** available extensions, the most in the PG extension ecosystem
