...
description: >
  Extensions are the soul of PostgreSQL. Pigsty builds, collects, and integrates 507 PG ecosystem extensions for out-of-the-box use.
weight: 20
outputs:
  - HTML
cascade:
...
- [**Extension Catalog**](/ext/list): Browse detailed information, usage, metadata, download links and docs for [**507**](/ext/list) extensions
...
- **Quantity**: Unparalleled extension count: **507** available extensions, the most in the PG extension ecosystem
