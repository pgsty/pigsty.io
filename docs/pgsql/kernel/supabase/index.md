...
and compared to Supabase cloud services, it provides up to [**576**](/ext/list/) out-of-the-box PostgreSQL extensions and can more fully utilize the performance and cost advantages of modern hardware.
...
<div id="td-asciinema-f5bd97f967a217c68b3338aaa0644225-1" class="td-asciinema td-max-width-on-larger-screens" data-td-asciinema
