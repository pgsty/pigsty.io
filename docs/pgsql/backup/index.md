...
- [Backup Mechanism](/docs/pgsql/backup/mechanism/): pgBackRest concepts—stanzas, repositories, backup chains, retention, and timelines—and how Pigsty maps parameters to commands.
- [Backup Policy](/docs/pgsql/backup/policy/): Design backup policies according to your needs
- [Backup Repository](/docs/pgsql/backup/repository/): Configure local, Silo, and external S3 backup repositories, including retention, encryption, versioning, and Object Lock.
- [Admin Commands](/docs/pgsql/backup/admin/): Backup administration reference covering setup and removal, manual backups, inspection, expiration, stanza management, logs, and alternative tools.
- [Restore Operations](/docs/pgsql/backup/restore/): Perform PITR with pgsql-pitr.yml, pig pitr, or pig pb restore; select targets, run stages, and verify the result.
- [Clone a PG Cluster](/docs/pgsql/backup/cluster/): Restore one cluster's historical state into another for data recovery, restore drills, and forensic inspection.
