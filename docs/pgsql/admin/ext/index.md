...
Pigsty provides [**576 extensions**](/ext/list). Using extensions involves four steps: **Download**, **Install**, **Configure**, **Enable**.
...
<div id="td-asciinema-22fd01c82749dbb97a73878df3f9a479-1" class="td-asciinema td-max-width-on-larger-screens" data-td-asciinema
  ...
  <div class="td-asciinema__chrome">
    ...
    <span class="td-asciinema__title" dir="auto">demo/pgsql-ext.cast</span>
  </div>
  <div data-td-asciinema-player></div>
  <script type="application/json" data-td-asciinema-config>{"options":{"autoPlay":true,"fit":"width","loop":true,"preload":false,"speed":1.2,"startAt":0},"src":"/demo/pgsql-ext.cast","theme":"auto"}</script>
</div>
...
- [**Extension Catalog**](/ext/list): Browse 576 available extensions
- [**pig Package Manager**](/docs/pig/): Extension installation CLI tool
