...
<div id="td-asciinema-28aabb2f554608ea183553e99424c940-0" class="td-asciinema td-max-width-on-larger-screens" data-td-asciinema
  ...
  <div class="td-asciinema__chrome">
    ...
    <span class="td-asciinema__title" dir="auto">demo/pgsql-config.cast</span>
  </div>
  <div data-td-asciinema-player></div>
  <script type="application/json" data-td-asciinema-config>{"options":{"autoPlay":true,"fit":"width","loop":true,"markers":[7,"Edit Config",9,"Apply",11,"Verify",13,"API Edit",14,"API Verify"],"preload":false,"speed":1.2,"startAt":0},"src":"/demo/pgsql-config.cast","theme":"auto"}</script>
</div>
