...
The single-node version of Pigsty includes all core features: **576** [**PG extensions**](/docs/pgsql/ext), self-contained Grafana/Victoria monitoring, [**IaC**](/docs/concept/iac) provisioning capabilities,
...
- [Single-Node Installation](/docs/setup/install/): Get started with Pigsty—complete single-node install on a fresh Linux host!
- [Docker Deployment](/docs/setup/docker/): Spin up Pigsty in Docker containers for quick testing on macOS/Windows
- [Web Interface](/docs/setup/webui/): Explore Pigsty's Web graphical management interface, Grafana dashboards, and how to access them via domain names and HTTPS.
- [Getting Started with PostgreSQL](/docs/setup/pgsql/): Get started with PostgreSQL—connect using CLI and graphical clients
- [Customize Pigsty with Configuration](/docs/setup/config/): Express your infra and clusters with declarative config files
- [Run Playbooks with Ansible](/docs/setup/playbook/): Use Ansible playbooks to deploy and manage Pigsty clusters
- [Offline Installation](/docs/setup/offline/): Install Pigsty in air-gapped env using offline packages
- [Slim Installation](/docs/setup/slim/): Install only HA PostgreSQL clusters with minimal dependencies
- [Security Recommendations](/docs/setup/security/): Basic security checks for quick-start and single-node deployments.
