...
- [**Extensibility**](/img/pigsty/ecosystem.png): Powerful [**extensions**](/ext/list) out of the box: deep integration of **PostGIS**, **TimescaleDB**, **Citus**, **PGVector**, [**576**](/ext/list/) plugins, and [**12 PG kernels**](/docs/pgsql/kernel).
...
- [Rich Extensions](#rich-extensions): Providing unparalleled 576 extensions with out-of-the-box distributed, time-series, geospatial, graph, vector, multi-modal database capabilities.
...
- Out-of-the-box [PostgreSQL](https://www.postgresql.org/) distribution, deeply integrating 576 [packaged extensions](/ext/list/) for geospatial, time-series, distributed, graph, vector, search, and AI!
...
PostgreSQL's soul lies in its rich [**extension ecosystem**](/blog/pg/pg-eat-db-world), and Pigsty uniquely deeply integrates [**576 extensions**](/ext/list) from the PostgreSQL ecosystem, providing you with an out-of-the-box hyper-converged multi-modal database!
