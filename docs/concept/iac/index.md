...
- [Inventory](/docs/concept/iac/inventory/): Describe your infrastructure and clusters using declarative configuration files
- [Configure](/docs/concept/iac/configure/): Use the configure script to automatically generate recommended configuration files based on your environment.
- [Parameters](/docs/concept/iac/parameter/): Fine-tune Pigsty customization using configuration parameters
- [Conf Templates](/docs/concept/iac/template/): Use pre-made configuration templates to quickly generate configuration files adapted to your environment
- [Use CMDB as Config Inventory](/docs/concept/iac/cmdb/): Use PostgreSQL as a CMDB metabase to store Ansible inventory.
